        ...
        return (
            <View style={styles.viewShadow}>
                ...
                <View style={{ padding: 50,alignItems: "center" }}>
                    <CustBtn title="Update Address" onpress={this.updateAddress}  color="#fff" style={{ backgroundColor: "#000" }}  />
                    </View>
        ...
        return (
            <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer} refreshControl={
                ...
                <View style={styles.viewShadow}>
                    ...
                    <View style={{ padding: 50, alignItems: "center" }}>
                        <CustBtn title="Update" onpress={this.updateData} color="#fff" style={{ backgroundColor: "#000" }} />
                    </View>
                ...
                <View style={styles.viewShadow}>
                    ...
                    <View style={{ padding: 50 ,alignItems: "center" }}>
                        <CustBtn title="Update Password" onpress={this.updatePassword} color="#fff" style={{ backgroundColor: "#000" }} />
                    </View>
                </View>
                ...
                <View style={{ padding: 50 ,alignItems: "center" }}>
                    <CustBtn color="#fff" style={{ backgroundColor: "#000",marginTop:'10%' }} title="Logout" BgColor='#000' onpress={this.loggedOut} />
                </View>
            </ScrollView>
        );
    }
