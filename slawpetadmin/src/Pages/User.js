...
export default class User extends Component {
  ...
  fetchUsers() {
    fetch(api + "/userAdmin", {
      ...
      .then((data) => {
        this.setState({ users: data.selected })
      })
              ...
              return (
                <div style={{
                  ...
                  <div style={{ display: "flex", flexDirection: "column", flexWrap: 'warp', alignItems: "center" }}>
                    <img alt="profile" style={{ width: 75, height: 75, borderRadius: 50, backgroundColor: "#aeefec" }}
                  ...
                  {odd.disable
                    ?
                    <Button onClick={() => { this.enableAccount(odd.account_id) }}>Enable</Button>

                    :
                    <Button type="primary" danger onClick={() => { this.disableAccount(odd.account_id) }}>Disable</Button>
                  }
                </div>
              );
            })}
